<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2><?= formname('Sửa nhà cung cấp','Thêm nhà cung cấp')?></h2>
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" method="post" action="<?= href('supplier', (isset($_GET['id'])) ? 'update' : 'store') ?>">
